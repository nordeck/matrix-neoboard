...
| `strokeWidth`           | `number \| undefined`            | The stroke width of the path in pixels. Only applicable to `polyline` paths at this time. Has a default width of 4 if undefined or zero. |
