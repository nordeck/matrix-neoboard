...
Elements can be attached to frames via different operations: moving, frame resizing, pasting and
drag and drop elements to frames. Frames can't be attached to other frames.

Frames apply changes to the attached elements when the frame is is moved or resized or in the case of other operations.
