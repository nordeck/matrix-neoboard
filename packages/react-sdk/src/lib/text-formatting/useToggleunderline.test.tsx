...
import { useToggleUnderline } from './useToggleUnderline';

describe('useToggleUnderline', () => {
    ...
    const { whiteboardManager } = mockWhiteboardManager({
      slides: [
        [
          'slide',
          [
            ['rectangle', mockRectangleElement({ textUnderline: false })],
            ['circle', mockCircleElement({ textUnderline: true })],
            ['triangle', mockTriangleElement({ textUnderline: false })],
  ...
  it('should reflect the underline text state of the first element (not underlined)', () => {
  ...
  it('should switch underline text for several elements', async () => {
    const { result } = renderHook(useToggleUnderline, { wrapper: Wrapper });
