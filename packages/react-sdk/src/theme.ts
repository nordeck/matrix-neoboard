  ...
  components: {
    MuiCssBaseline: {
      styleOverrides: `
                ...
                @font-face {
                    font-family: 'Adamina';
                    src: local('Adamina'), url('/fonts/Adamina-Regular.ttf') format('truetype');
                    font-weight: normal;
                    font-style: normal;
                    font-display: swap;
                }
                ...
                @font-face {
                    ...
                    src: local('Gwendolyn'), url('/fonts/Gwendolyn-Regular.ttf') format('truetype');
                    font-weight: normal;
                    font-style: normal;
                    font-display: swap;
                }
                ...
                @font-face {
                    ...
                    src: local('Pirata One'), url('/fonts/PirataOne-Regular.ttf') format('truetype');
                    font-weight: normal;
                    font-style: normal;
                    font-display: swap;
                }
