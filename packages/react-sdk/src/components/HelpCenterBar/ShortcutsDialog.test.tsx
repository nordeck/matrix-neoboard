...
describe('<ShortcutsDialog/>', () => {
  ...
  it('should not show Y for redo on macOS', () => {
    ...
    // macOS redo is meta+shift+z — Y should not appear anywhere
    expect(screen.queryByText('Y')).not.toBeInTheDocument();
  });

  it('should call onClose when the icon close button is clicked', async () => {
    render(<ShortcutsDialog open onClose={onClose} />);
  ...
  it('should call onClose when the footer close button is clicked', async () => {
    render(<ShortcutsDialog open onClose={onClose} />);
