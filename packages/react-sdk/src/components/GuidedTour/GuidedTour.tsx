          ...
          content: (
            <Trans i18nKey="guidedTour.slideOverview.content">
              <p>
                ...
                can open the context menu and delete existing slides, lock them
                to prevent changes or bring all participants here. Hold down the
                left mouse button to change the order of the slides.
              </p>
            </Trans>
          ),
          disableBeacon: true,
          ...
          content: (
            <Trans i18nKey="guidedTour.toolsbar.content">
              <p>
                ...
                anywhere on the slide to place it. Draw shapes by moving the
                mouse while holding down the left mouse button. You can place
                text in the same way and start typing right away.
              </p>
            </Trans>
          ),
          disableBeacon: true,
          ...
          content: (
            <Trans i18nKey="guidedTour.collaborationBar.content">
              <p>
                ...
                number to the right of the first five participants to see who
                else is online. With the small eye you can show or hide the
                cursors of the others.
              </p>
            </Trans>
          ),
          disableBeacon: true,
          ...
          content: (
            <Trans i18nKey="guidedTour.helpCenter.content">
              <p>
                ...
                tour at any time so you can explore everything in more detail.
              </p>
