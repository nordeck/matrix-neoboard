...
- ff986c5: Support underline text formatting

### Patch Changes

- c37fe96: Switch lodash imports to per-function entry points
- c089586: Fixed elements getting detached from a frame when the frame gets interactions using the select/move touch gestures.
- b0577db: Fixes LiveKit JWT Service rejection of raw Widget API provided OpenID tokens
